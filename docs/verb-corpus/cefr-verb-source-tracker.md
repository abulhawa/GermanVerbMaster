...
| goethe_dtz | Alphabetical DTZ Wortliste (Goethe-Institut) | DTZ (A2–B1) | https://www.goethe.de/resources/files/pdf209/dtz_wortliste.pdf | Copyright © Goethe-Institut | ? Parsed 480 verb lemmas (text capture: `goethe-dtz-wortliste.txt`; see `dtz-verb-list.csv`)
