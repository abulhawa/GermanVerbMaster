...
import {
  addExpectedForm,
  buildAdjectiveInstruction,
  buildAdjectivePromptSummary,
...
export function AdjectiveEndingRenderer({
  task,
  settings,
  onResult,
  className,
  ...
  const instructionText = useMemo(() => buildAdjectiveInstruction(copy, task), [copy, task]);
